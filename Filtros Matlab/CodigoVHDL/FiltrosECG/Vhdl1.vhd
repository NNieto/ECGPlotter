...
--
-- TargetLanguage: VHDL
-- TargetDirectory: C:\Users\Alejandro\Documents\GitHub\Dev-Java\ECGPlotter\Filtros Matlab\CodigoVHDL\FiltroPasaBajas100
-- Name: FiltroPasaBajas100
...
END FiltroPasaBajas100;


----------------------------------------------------------------
--Module Architecture: FiltroPasaBajas100
----------------------------------------------------------------
ARCHITECTURE rtl OF FiltroPasaBajas100 IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF real; -- double
  -- Constants
  CONSTANT coeff1                         : real := 4.9808477230459289E-06; -- double
  CONSTANT coeff2                         : real := 7.6349142673709476E-06; -- double
  CONSTANT coeff3                         : real := 1.3588910054237056E-05; -- double
  CONSTANT coeff4                         : real := 2.2544207972219612E-05; -- double
  CONSTANT coeff5                         : real := 3.5535338553293484E-05; -- double
  CONSTANT coeff6                         : real := 5.3829816187659026E-05; -- double
  CONSTANT coeff7                         : real := 7.8953203030915120E-05; -- double
  CONSTANT coeff8                         : real := 1.1271134240134267E-04; -- double
  CONSTANT coeff9                         : real := 1.5720840972941082E-04; -- double
  CONSTANT coeff10                        : real := 2.1485936092932793E-04; -- double
  CONSTANT coeff11                        : real := 2.8839533760464567E-04; -- double
  CONSTANT coeff12                        : real := 3.8086062292924634E-04; -- double
  CONSTANT coeff13                        : real := 4.9559983690630803E-04; -- double
  CONSTANT coeff14                        : real := 6.3623421851386169E-04; -- double
  CONSTANT coeff15                        : real := 8.0662606611001250E-04; -- double
  CONSTANT coeff16                        : real := 1.0108306948209077E-03; -- double
  CONSTANT coeff17                        : real := 1.2530356160236618E-03; -- double
  CONSTANT coeff18                        : real := 1.5374870420749749E-03; -- double
  CONSTANT coeff19                        : real := 1.8684042588516124E-03; -- double
  CONSTANT coeff20                        : real := 2.2498828765029058E-03; -- double
  CONSTANT coeff21                        : real := 2.6857884497590080E-03; -- double
  CONSTANT coeff22                        : real := 3.1796424359985418E-03; -- double
  CONSTANT coeff23                        : real := 3.7345029135638181E-03; -- double
  CONSTANT coeff24                        : real := 4.3528428954164866E-03; -- double
  CONSTANT coeff25                        : real := 5.0364294251939090E-03; -- double
  CONSTANT coeff26                        : real := 5.7862069160519811E-03; -- double
  CONSTANT coeff27                        : real := 6.6021883711254196E-03; -- double
  CONSTANT coeff28                        : real := 7.4833581943206974E-03; -- double
  CONSTANT coeff29                        : real := 8.4275902510810297E-03; -- double
  CONSTANT coeff30                        : real := 9.4315846642377531E-03; -- double
  CONSTANT coeff31                        : real := 1.0490826528002990E-02; -- double
  CONSTANT coeff32                        : real := 1.1599569296215455E-02; -- double
  CONSTANT coeff33                        : real := 1.2750845056663922E-02; -- double
  CONSTANT coeff34                        : real := 1.3936503254055181E-02; -- double
  CONSTANT coeff35                        : real := 1.5147278686924103E-02; -- double
  CONSTANT coeff36                        : real := 1.6372888799584106E-02; -- double
  CONSTANT coeff37                        : real := 1.7602159443644887E-02; -- double
  CONSTANT coeff38                        : real := 1.8823177421895650E-02; -- double
  CONSTANT coeff39                        : real := 2.0023467279375554E-02; -- double
  CONSTANT coeff40                        : real := 2.1190189001771869E-02; -- double
  CONSTANT coeff41                        : real := 2.2310352548947740E-02; -- double
  CONSTANT coeff42                        : real := 2.3371044518816424E-02; -- double
  CONSTANT coeff43                        : real := 2.4359661728613771E-02; -- double
  CONSTANT coeff44                        : real := 2.5264146137767868E-02; -- double
  CONSTANT coeff45                        : real := 2.6073215335245089E-02; -- double
  CONSTANT coeff46                        : real := 2.6776582785275786E-02; -- double
  CONSTANT coeff47                        : real := 2.7365162173608442E-02; -- double
  CONSTANT coeff48                        : real := 2.7831250520544085E-02; -- double
  CONSTANT coeff49                        : real := 2.8168685219305566E-02; -- double
  CONSTANT coeff50                        : real := 2.8372970805041108E-02; -- double
  CONSTANT coeff51                        : real := 2.8441372041529318E-02; -- double
  CONSTANT coeff52                        : real := 2.8372970805041108E-02; -- double
  CONSTANT coeff53                        : real := 2.8168685219305566E-02; -- double
  CONSTANT coeff54                        : real := 2.7831250520544085E-02; -- double
  CONSTANT coeff55                        : real := 2.7365162173608442E-02; -- double
  CONSTANT coeff56                        : real := 2.6776582785275786E-02; -- double
  CONSTANT coeff57                        : real := 2.6073215335245089E-02; -- double
  CONSTANT coeff58                        : real := 2.5264146137767868E-02; -- double
  CONSTANT coeff59                        : real := 2.4359661728613771E-02; -- double
  CONSTANT coeff60                        : real := 2.3371044518816424E-02; -- double
  CONSTANT coeff61                        : real := 2.2310352548947740E-02; -- double
  CONSTANT coeff62                        : real := 2.1190189001771869E-02; -- double
  CONSTANT coeff63                        : real := 2.0023467279375554E-02; -- double
  CONSTANT coeff64                        : real := 1.8823177421895650E-02; -- double
  CONSTANT coeff65                        : real := 1.7602159443644887E-02; -- double
  CONSTANT coeff66                        : real := 1.6372888799584106E-02; -- double
  CONSTANT coeff67                        : real := 1.5147278686924103E-02; -- double
  CONSTANT coeff68                        : real := 1.3936503254055181E-02; -- double
  CONSTANT coeff69                        : real := 1.2750845056663922E-02; -- double
  CONSTANT coeff70                        : real := 1.1599569296215455E-02; -- double
  CONSTANT coeff71                        : real := 1.0490826528002990E-02; -- double
  CONSTANT coeff72                        : real := 9.4315846642377531E-03; -- double
  CONSTANT coeff73                        : real := 8.4275902510810297E-03; -- double
  CONSTANT coeff74                        : real := 7.4833581943206974E-03; -- double
  CONSTANT coeff75                        : real := 6.6021883711254196E-03; -- double
  CONSTANT coeff76                        : real := 5.7862069160519811E-03; -- double
  CONSTANT coeff77                        : real := 5.0364294251939090E-03; -- double
  CONSTANT coeff78                        : real := 4.3528428954164866E-03; -- double
  CONSTANT coeff79                        : real := 3.7345029135638181E-03; -- double
  CONSTANT coeff80                        : real := 3.1796424359985418E-03; -- double
  CONSTANT coeff81                        : real := 2.6857884497590080E-03; -- double
  CONSTANT coeff82                        : real := 2.2498828765029058E-03; -- double
  CONSTANT coeff83                        : real := 1.8684042588516124E-03; -- double
  CONSTANT coeff84                        : real := 1.5374870420749749E-03; -- double
  CONSTANT coeff85                        : real := 1.2530356160236618E-03; -- double
  CONSTANT coeff86                        : real := 1.0108306948209077E-03; -- double
  CONSTANT coeff87                        : real := 8.0662606611001250E-04; -- double
  CONSTANT coeff88                        : real := 6.3623421851386169E-04; -- double
  CONSTANT coeff89                        : real := 4.9559983690630803E-04; -- double
  CONSTANT coeff90                        : real := 3.8086062292924634E-04; -- double
  CONSTANT coeff91                        : real := 2.8839533760464567E-04; -- double
  CONSTANT coeff92                        : real := 2.1485936092932793E-04; -- double
  CONSTANT coeff93                        : real := 1.5720840972941082E-04; -- double
  CONSTANT coeff94                        : real := 1.1271134240134267E-04; -- double
  CONSTANT coeff95                        : real := 7.8953203030915120E-05; -- double
  CONSTANT coeff96                        : real := 5.3829816187659026E-05; -- double
  CONSTANT coeff97                        : real := 3.5535338553293484E-05; -- double
  CONSTANT coeff98                        : real := 2.2544207972219612E-05; -- double
  CONSTANT coeff99                        : real := 1.3588910054237056E-05; -- double
  CONSTANT coeff100                       : real := 7.6349142673709476E-06; -- double
  CONSTANT coeff101                       : real := 4.9808477230459289E-06; -- double
